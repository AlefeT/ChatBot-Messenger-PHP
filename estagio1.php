...
if (ctype_digit($text)){
	...
	if($nomecliente != ''){
        ...
        mysqli_query($db2, "INSERT INTO CANAL_LOG (canal, horario, contratante, cpfcliente) VALUES ('TELEGRAM','$horario','abcTEL','$text');"); 
     
    // Atualiza estagio
	$rv = mysqli_query($db, "UPDATE dkdatabase.tabela SET estagio = '2', cpf = '$text', datapagto = '$resultado[4]', numcredor = '$resultado[2]', numdivida = '$resultado[3]', unixtime = $currentunix WHERE senderid = $chatId;");
